...
class PageBaseViewController: UIPageViewController, SlideMenuDelegate {
    ...
    @objc func onSlideMenuButtonPressed(_ sender : UIButton){
        ...
        let menuVC : MenuPageViewController = self.storyboard!.instantiateViewController(withIdentifier: "MenuPageViewController") as! MenuPageViewController
